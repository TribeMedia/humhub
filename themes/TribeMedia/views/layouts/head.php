...
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/variables.css" rel="stylesheet">
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/bootswatch.min.css" rel="stylesheet">
<!-- end: CSS -->
